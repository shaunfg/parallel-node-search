...
module tf
    ...
    # function warm_start(depth::Int,p::Int,z,e,y,x)
        ...
        rf = build_forest(y,x,floor(Int,sqrt(p)),rf_ntrees,1.0,depth,rng = seed)
    ...
    function subtree_inputs(Tt::Tree,z::Array{Float64,2},x,y)
